...
public class Graph_gapx extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_graph_gapx);

        ImageButton play=(ImageButton)findViewById(R.id.play_x);
        ...
        ImageButton menub=(ImageButton)findViewById(R.id.menubar_gapx);
                ...
                p.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
                    ...
                    public boolean onMenuItemClick(MenuItem item) {
                        ...
                        switch (item.getItemId()){
                            case R.id.temp:
                                intent=new Intent(Graph_gapx.this,GraphActivity.class);
                                startActivity(intent);
                                return true;

                            case R.id.rpm:
                                intent=new Intent(Graph_gapx.this,Graph_rpm.class);
                                startActivity(intent);
                                return true;

                            case R.id.gap_y:
                                intent=new Intent(Graph_gapx.this, Graph_gapy.class);
                                startActivity(intent);
                                return true;

                            case R.id.gap_x:
                                intent=new Intent(Graph_gapx.this, Graph_gapx.class);
                                startActivity(intent);
                                return true;
                        }
                        return false;
        ...
        Button showButton = (Button) findViewById(R.id.btn_show_data_gap);
        ...
        chart = (LineChart) findViewById(R.id.chart_gap);
...
// don't forget to refresh the drawing
        ...
        Button startbtn = (Button)findViewById(R.id.btn_start_gap);
        ...
        Button stopbtn = (Button)findViewById(R.id.btn_stop_gap);
    ...
    class BackgroundTask extends AsyncTask<Void, Void, String> {
        ...
        protected void onPreExecute() {
            ...
            target = "http://13.59.96.134/gapxData.php";
        }
        ...
        protected void onPostExecute(String result) {
            Intent intent = new Intent(Graph_gapx.this, gapData.class);
            intent.putExtra("dataList", result);//파싱한 값을 넘겨줌
            Graph_gapx.this.startActivity(intent);//ManagementActivity로 넘어감
        }
    }
