...
public class Graph_gapy extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_graph_gapy);

        ImageButton play=(ImageButton)findViewById(R.id.play_y);
        ...
        ImageButton menub=(ImageButton)findViewById(R.id.menubar_gapy);
                ...
                p.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
                    ...
                    public boolean onMenuItemClick(MenuItem item) {
                        ...
                        switch (item.getItemId()){
                            case R.id.temp:
                                intent=new Intent(Graph_gapy.this,GraphActivity.class);
                                startActivity(intent);
                                return true;

                            case R.id.rpm:
                                intent=new Intent(Graph_gapy.this,Graph_rpm.class);
                                startActivity(intent);
                                return true;

                            case R.id.gap_y:
                                intent=new Intent(Graph_gapy.this, Graph_gapy.class);
                                startActivity(intent);
                                return true;

                            case R.id.gap_x:
                                intent=new Intent(Graph_gapy.this, Graph_gapx.class);
                                startActivity(intent);
                                return true;
        ...
        Button showButton = (Button) findViewById(R.id.btn_show_data_prox);
        ...
        chart = (LineChart) findViewById(R.id.chart_prox);
...
//Y축
        ...
        Button startbtn = (Button)findViewById(R.id.btn_start_prox);
        ...
        Button stopbtn = (Button)findViewById(R.id.btn_stop_prox);
    ...
    class BackgroundTask extends AsyncTask<Void, Void, String> {
        ...
        protected void onPreExecute() {
            ...
            target = "http://13.59.96.134/gapyData.php";
        }
        ...
        protected void onPostExecute(String result) {
            Intent intent = new Intent(Graph_gapy.this, gapyData.class);
            intent.putExtra("dataList", result);//파싱한 값을 넘겨줌
            Graph_gapy.this.startActivity(intent);//ManagementActivity로 넘어감
        }
    }
    //그래프 통신
